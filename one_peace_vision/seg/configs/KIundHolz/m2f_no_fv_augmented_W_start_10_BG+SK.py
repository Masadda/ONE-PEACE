_base_ = [
    '../_base_/models/mask2former_KIundHolz_W_start_10BG+SK.py',
    '../_base_/datasets/KIundHolz_no_fv_augmented.py',
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_5k_eval_2.5k.py'
]
crop_size = (512, 512)
...
checkpoint_config = dict(by_epoch=False, interval=8000, max_keep_ckpts=1, create_symlink=False)
